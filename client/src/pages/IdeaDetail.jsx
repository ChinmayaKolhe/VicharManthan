...
import {
  ArrowLeft, ThumbsUp, MessageCircle, Users, Calendar, Send, Edit, Trash2, UserPlus, Upload, FileText
} from 'lucide-react';
  ...
  const handleProposalSubmit = async (e) => {
    ...
    try {
      ...
      if (resumeBase64 && resumeFile) {
        proposalPayload.resume = resumeBase64;
        proposalPayload.resumeFileName = resumeFile.name;
      }

      await axios.post('/api/proposals', proposalPayload);
                  ...
                  <form onSubmit={handleProposalSubmit} className="proposal-form">
                    ...
                    <div className="form-group">
                      ...
                      <p style={{ fontSize: '12px', color: '#6b7280', marginTop: '4px' }}>
                        Upload your resume to help the founder understand your background (Max 5MB)
                      </p>
                    </div>
