...
const Ideas = () => {
  ...
  const fetchIdeas = async () => {
    try {
      ...
      if (isMyIdeas && user) params.append('userId', user._id);
      ...
      <div className="container">
        <div className="ideas-header">
          <div className="ideas-title">
            <h1>{isMyIdeas ? 'My Ideas' : 'Explore Startup Ideas'}</h1>
            <p>{isMyIdeas ? 'Manage and track your posted ideas' : 'Discover innovative ideas and collaborate with talented founders'}</p>
          </div>
          {isAuthenticated && (
