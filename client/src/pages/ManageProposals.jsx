...
import { ArrowLeft, CheckCircle, XCircle, User, Mail, Briefcase, FileText } from 'lucide-react';
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="flex items-center gap-2">
                      {proposal.resume && (
                        <button
                          onClick={() => handleViewResume(proposal.resume, proposal.resumeFileName)}
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-200">
                      <div className="flex items-center gap-2 bg-blue-50 border border-blue-200 rounded-lg px-4 py-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-blue-700">{proposal.resumeFileName}</p>
                        </div>
                      </div>
                    </div>
                  )}
