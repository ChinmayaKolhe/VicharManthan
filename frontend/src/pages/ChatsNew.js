              ...
              <div className="p-6 border-b border-gray-200">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-purple-500 transition"
                  />
                </div>
                    ...
                    {filteredUsers.length === 0 ? (
                      ...
                      filteredUsers.map((u) => (
                        <div
                          ...
                          className="flex items-center gap-3 p-4 hover:bg-purple-50 cursor-pointer transition"
                        >
                          <img
